"""
Helper utilities for Logic Arena game.
"""
import pygame
import os
import random
import json
from config import IMAGES_DIR, SOUNDS_DIR, FONTS_DIR, QUESTIONS_DIR

def load_image(filename, directory=IMAGES_DIR):
...
def load_questions(difficulty):
    """Load questions from JSON file based on difficulty."""
    try:
        filename = os.path.join(QUESTIONS_DIR, f"{difficulty}.json")
